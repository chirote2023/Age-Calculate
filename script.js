...
//     const currentDate = today.getData();

//     if(isFutureDate(birthDetails,currentYear,currentMonth,currentDate)
//     ){
// alert("Not Borning Yet");
// displayResult("-","-","-");
// return;
// }

// const {years,months,days} =calclateAge(birthDetails,currentYear,currentMonth,currentDate);
...
// const calclateAge = (birthDetails,currentYear,currentMonth,currentDate)=>{
...
//         31,
//       ];
//       return daysInLastMonth[month -1];
// };
